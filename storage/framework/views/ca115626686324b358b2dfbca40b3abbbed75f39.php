...
<div class="row justify-content-center">
    <div class="col-lg-5 col-md-11 col-11">
        <div class="content p-5">
            ...
            <div class="mt-2">
                <form action="<?php echo e(route('call.laporanUpdate', $pengaduan->id_pengaduan)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
                    <div class="form-group">
                        <label for="judul_laporan">Judul Laporan</label>
                        <input type="text" value="<?php echo e($pengaduan->judul_laporan); ?>" name="judul_laporan" id="judul_laporan"
...
unset($__errorArgs, $__bag); ?>"><?php echo e($pengaduan->isi_laporan); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e($pengaduan->tgl_kejadian->format('d-m-Y')); ?>" name="tgl_kejadian"
...
unset($__errorArgs, $__bag); ?> mb-3"
                            placeholder="Tulis Lokasi Kejadian"><?php echo e($pengaduan->lokasi_kejadian); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <select name="kategori_kejadian" id="kategori_kejadian" class="custom-select" required>
                                <?php if($pengaduan->kategori_kejadian == 'agama'): ?>
                                <option selected value="agama">Agama</option>
                                <option value="hukum">Hukum</option>
                                <option value="lingkungan">Lingkungan</option>
                                <option value="sosial">Sosial</option>
                                <?php elseif($pengaduan->kategori_kejadian == 'hukum'): ?>
                                <option value="agama">Agama</option>
                                <option selected value="hukum">Hukum</option>
                                <option value="lingkungan">Lingkungan</option>
                                <option value="sosial">Sosial</option>
                                <?php elseif($pengaduan->kategori_kejadian == 'lingkungan'): ?>
                                <option value="agama">Agama</option>
                                <option value="hukum">Hukum</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" value="<?php echo e($pengaduan->foto); ?>" name="foto" id="foto" class="form-control <?php $__errorArgs = ['file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php $__env->startSection('js'); ?>
    ...
    <?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\backup c\documents\Tugas\laporan-app\resources\views/user/edit.blade.php ENDPATH**/ ?>